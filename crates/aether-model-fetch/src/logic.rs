...
mod tests {
    ...
    use super::{
        ...
        parse_models_response_page, selected_models_fetch_endpoints,
    };
    ...
    fn build_models_fetch_url_supports_openai_responses() {
        assert_eq!(
            build_models_fetch_url("openai:responses", "https://example.com"),
            Some((
    ...
    fn build_models_fetch_url_preserves_unversioned_api_root() {
        assert_eq!(
            build_models_fetch_url("openai:chat", "https://proxy.example.com/api"),
            Some((
        ...
        assert_eq!(
            build_models_fetch_url("openai:chat", "https://proxy.example.com/openai"),
            Some((
        ...
        assert_eq!(
            build_models_fetch_url("openai:chat", "https://proxy.example.com"),
            Some((
        ...
        assert_eq!(
            build_models_fetch_url("openai:chat", "https://api.deepseek.com"),
            Some((
        ...
        assert_eq!(
            build_models_fetch_url("claude:messages", "https://proxy.example.com/api"),
            Some((
                "https://proxy.example.com/api/models".to_string(),
    ...
    fn build_models_fetch_url_uses_deepseek_openai_models_for_anthropic_base() {
        assert_eq!(
            build_models_fetch_url("claude:messages", "https://api.deepseek.com/anthropic"),
            Some((
                "https://api.deepseek.com/models".to_string(),
                "claude:messages".to_string()
            ))
