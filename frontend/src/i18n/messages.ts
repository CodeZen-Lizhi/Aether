...
const legacyExactEnglishMessages: Record<string, string> = {
  ...
  '流式首输出总预算': 'Streaming first-output budget',
  '(毫秒)': '(ms)',
  ...
  '首输出总预算必须在 0.001 到 1200 秒之间，最多保留三位小数': 'First-output budget must be between 0.001 and 1200 seconds, with up to three decimal places',
  '从请求开始到首次有效输出的总等待上限，包含重试和切换；不限制完整回答时长。': 'Maximum wait from request start to the first useful output, including retries and failover; does not limit the full answer duration.',
  '默认 2': 'Default 2',
