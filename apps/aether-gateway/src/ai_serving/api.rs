...
pub(crate) use aether_ai_formats::api::{
    ...
    core_success_background_report_kind, extract_stream_terminal_error_body,
    implicit_sync_finalize_report_kind, is_core_error_finalize_kind, resolve_claude_stream_spec,
