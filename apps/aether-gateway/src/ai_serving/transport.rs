...
pub(crate) use aether_provider_transport::{
    ...
    resolve_anthropic_compatibility_profile, resolve_gemini_files_auth, resolve_openai_image_auth,
    ...
    should_skip_upstream_passthrough_header, supports_local_gemini_transport_with_network,
    ...
    CandidateTransportPolicyFacts, GatewayProviderTransportSnapshot, GeminiFilesHeadersInput,
    GeminiFilesRequestBodyError, GeminiFilesRequestBodyParts, ProviderOpenAiImageHeadersInput,
    ...
    TransportRequestBodySemanticsError, TransportRequestUrlParams,
};
