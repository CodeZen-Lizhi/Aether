...
- [现有客户端需求](/Users/zhenglizhi/otherProjects/Aether-tauri-macos/docs/tasks/09-09-tauri-macos/prd.md)。
- [桌面宿主与网关契约](/Users/zhenglizhi/otherProjects/Aether-tauri-macos/docs/specs/aether-desktop/backend/desktop-contract.md)。
