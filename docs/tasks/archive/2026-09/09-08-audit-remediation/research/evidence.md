...
- routing core policy.rs:108 简化入口仍执行 :209 RestrictModels、:242 SetKeyPriority，且 GlobalKey 可由 default/actions 流入；这些和已确认 R11 验收不一致。旧 R11 见 docs/tasks/archive/2026-09/09-01-scheduling-upgrade/prd.md:79–110、148–149。
