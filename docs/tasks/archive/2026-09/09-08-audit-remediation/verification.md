...
| R7 交付 | 类型/编译、局部回归、代码和 SQL 审查完成；同步数据、网关、路由及前端规范 | `docs/specs/`、本任务记录和开发日志 |
...
| `python3 .trellis/scripts/task.py validate docs/tasks/09-08-audit-remediation` | 通过，implement/check context 各 4 条 |
