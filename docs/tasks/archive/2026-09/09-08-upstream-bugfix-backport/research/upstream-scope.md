...
代理语义依据：`docs/tasks/archive/2026-09/09-02-proxy-ui-polish/design.md:54`、`docs/specs/frontend/index.md:79`、`frontend/src/views/admin/system-settings/__tests__/ProxyNodeEditDialog.spec.ts:379`。现有两种 scheme 都能保存，不能把上游策略变化当成分支缺陷。
