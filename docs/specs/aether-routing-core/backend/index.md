# aether-routing-core 开发入口

范围：`crates/aether-routing-core/`。以当前 workspace 的包定义和实际导出定位代码。

## Pre-Development Checklist

- [包定义](../../../../crates/aether-routing-core/Cargo.toml) 与 [实现入口](../../../../crates/aether-routing-core/src/lib.rs)：核对 feature、依赖和直接调用方。
...
- [Simplified Routing and Configuration Round Trip](simplified-routing.md)
