...
范围：`crates/aether-billing/`。以当前 workspace 的包定义和实际导出定位代码。

## Pre-Development Checklist

- [包定义](../../../../crates/aether-billing/Cargo.toml) 与 [实现入口](../../../../crates/aether-billing/src/lib.rs)：核对 feature、依赖和直接调用方。
