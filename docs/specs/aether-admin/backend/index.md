...
范围：`crates/aether-admin/`。以当前 workspace 的包定义和实际导出定位代码。

## Pre-Development Checklist

- [包定义](../../../../crates/aether-admin/Cargo.toml) 与 [实现入口](../../../../crates/aether-admin/src/lib.rs)：核对 feature、依赖和直接调用方。
...
- [Provider Ops 错误处理](error-handling.md)
- [Provider Ops 认证方式契约](quality-guidelines.md)
